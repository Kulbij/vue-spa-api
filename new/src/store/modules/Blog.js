...
export default {
    ...
    mutations: {
        ...
        ListPublishedPosts(state, payload) {
    ...
    actions: {
        ...
        async ListPublishedPosts({ getters, dispatch, commit }) {
            try {
                if (!getters.ROUTERS) await dispatch("GetRouters");

                let { data } = await api.get(getters.ROUTERS.postPublished);
        ...
        async UpdatePost({ dispatch, getters, commit }, payload) {
            try {
                if (!getters.ROUTERS) await dispatch("GetRouters");
        ...
        async ListPostCategories({ dispatch, getters, commit }, payload) {
            try {
                if (!getters.ROUTERS) await dispatch("GetRouters");
