...
const routes = [
  ...
  },
  {
      ...
      name: "AccountMyBlog",
      component: () => import("../views/account/MyBlog.vue"),
      meta: {
          seoName: "my-blog"
      },
  },
  {
      ...
      component: () => import("../views/account/PostAdd.vue"),
  },
  {
      path: pr.accountPostUpdate,
      name: "AccountPostEdit",
      component: () => import("../views/account/PostEdit.vue"),
      props: true,
      // beforeEnter: (to, from, next) => {
      //     store.dispatch("GetOnePost", to.params.id);
      //     next();
      // }
  },
